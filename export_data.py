...
async def export_data_to_csv():
    ...
    try:
        ...
        os.makedirs("exports/pair_data", exist_ok=True)
        os.makedirs("exports/token_metadata", exist_ok=True)
        
        # Export pair data
        pair_filename = f"exports/pair_data/pair_data_{timestamp}.csv"
        ...
        token_filename = f"exports/token_metadata/token_metadata_{timestamp}.csv"
